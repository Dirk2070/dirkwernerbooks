...
NODE_VERSION=18
VITE_SITE_URL=https://dirkwernerbooks.com
```
...
### Preview Deployments:
- **Production**: https://dirkwernerbooks.com
...
Die Website wird nach dem Deployment unter **https://dirkwernerbooks.com** verfügbar sein mit automatischem SSL und weltweiter Performance-Optimierung.
